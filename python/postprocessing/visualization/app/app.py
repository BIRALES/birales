...
# Beam routes
api.add_resource(RawBeam, '/monitoring/<string:observation>/<string:data_set>/beam/<int:beam_id>/raw')
api.add_resource(FilteredBeam, '/monitoring/<string:observation>/<string:data_set>/beam/<int:beam_id>/filtered')

# Multi-beam routes
api.add_resource(RawMultiBeam, '/monitoring/<string:observation>/<string:data_set>/multi_beam/raw')
api.add_resource(FilteredMultiBeam, '/monitoring/<string:observation>/<string:data_set>/multi_beam/filtered')
