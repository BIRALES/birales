...
class Tile(object):
    ...
    def __new__(
        ...
        :param ddc_frequency: ADC DDC frequency
        ...
        if _tpm_version == "tpm_v1_2":
            return cast(
                Tile, Tile_1_2(ip, port, lmc_ip, lmc_port, sampling_rate, ddc_frequency)
            )
        elif _tpm_version == "tpm_v1_6":
            return cast(
                Tile, Tile_1_6(ip, port, lmc_ip, lmc_port, sampling_rate, ddc_frequency)
            )
        else:
